// Typer PWA Service Worker (BUILD 3012)
const CACHE_NAME = 'typer-cache-3012';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3012',
  './manifest.json?v=3012',
  './apple-touch-icon.png?v=3012',
  './favicon-32x32.png?v=3012',
  './favicon-16x16.png?v=3012',
