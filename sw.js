// Typer PWA Service Worker (BUILD 3065)
const CACHE_NAME = 'typer-cache-3065';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3065',
  './manifest.json?v=3065',
  './apple-touch-icon.png?v=3065',
  './favicon-32x32.png?v=3065',
  './favicon-16x16.png?v=3065',
  './ui/loader_ball.webp',
