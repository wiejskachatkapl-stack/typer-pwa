// Typer PWA Service Worker (BUILD 3041)
const CACHE_NAME = 'typer-cache-3041';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3041',
  './manifest.json?v=3041',
  './apple-touch-icon.png?v=3041',
  './favicon-32x32.png?v=3041',
  './favicon-16x16.png?v=3041',
  './ui/loader_ball.webp',
