// Typer PWA Service Worker (BUILD 3008)
const CACHE_NAME = 'typer-cache-3008';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3008',
  './manifest.json?v=3008',
  './apple-touch-icon.png?v=3008',
  './favicon-32x32.png?v=3008',
  './favicon-16x16.png?v=3008',
