// Typer PWA Service Worker (BUILD 3023)
const CACHE_NAME = 'typer-cache-3023';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3023',
  './manifest.json?v=3023',
  './apple-touch-icon.png?v=3023',
  './favicon-32x32.png?v=3023',
  './favicon-16x16.png?v=3023',
