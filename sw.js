// Typer PWA Service Worker (BUILD 3015)
const CACHE_NAME = 'typer-cache-3015';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3015',
  './manifest.json?v=3015',
  './apple-touch-icon.png?v=3015',
  './favicon-32x32.png?v=3015',
  './favicon-16x16.png?v=3015',
