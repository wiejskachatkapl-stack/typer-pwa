// Typer PWA Service Worker (BUILD 3034)
const CACHE_NAME = 'typer-cache-3034';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3034',
  './manifest.json?v=3034',
  './apple-touch-icon.png?v=3034',
  './favicon-32x32.png?v=3034',
  './favicon-16x16.png?v=3034',
  './ui/loader_ball.webp',
