// Typer PWA Service Worker (BUILD 3020)
const CACHE_NAME = 'typer-cache-3020';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3020',
  './manifest.json?v=3020',
  './apple-touch-icon.png?v=3020',
  './favicon-32x32.png?v=3020',
  './favicon-16x16.png?v=3020',
