// Typer PWA Service Worker (BUILD 3042)
const CACHE_NAME = 'typer-cache-3042';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3042',
  './manifest.json?v=3042',
  './apple-touch-icon.png?v=3042',
  './favicon-32x32.png?v=3042',
  './favicon-16x16.png?v=3042',
  './ui/loader_ball.webp',
