// Typer PWA Service Worker (BUILD 3016)
const CACHE_NAME = 'typer-cache-3016';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3016',
  './manifest.json?v=3016',
  './apple-touch-icon.png?v=3016',
  './favicon-32x32.png?v=3016',
  './favicon-16x16.png?v=3016',
