// Typer PWA Service Worker (BUILD 3022)
const CACHE_NAME = 'typer-cache-3022';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3022',
  './manifest.json?v=3022',
  './apple-touch-icon.png?v=3022',
  './favicon-32x32.png?v=3022',
  './favicon-16x16.png?v=3022',
