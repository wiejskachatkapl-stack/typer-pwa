// Typer PWA Service Worker (BUILD 3029)
const CACHE_NAME = 'typer-cache-3029';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3029',
  './manifest.json?v=3029',
  './apple-touch-icon.png?v=3029',
  './favicon-32x32.png?v=3029',
  './favicon-16x16.png?v=3029',
