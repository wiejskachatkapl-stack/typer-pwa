// Typer PWA Service Worker (BUILD 3052)
const CACHE_NAME = 'typer-cache-3052';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3052',
  './manifest.json?v=3052',
  './apple-touch-icon.png?v=3052',
  './favicon-32x32.png?v=3052',
  './favicon-16x16.png?v=3052',
  './ui/loader_ball.webp',
