// Typer PWA Service Worker (BUILD 3024)
const CACHE_NAME = 'typer-cache-3024';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3024',
  './manifest.json?v=3024',
  './apple-touch-icon.png?v=3024',
  './favicon-32x32.png?v=3024',
  './favicon-16x16.png?v=3024',
