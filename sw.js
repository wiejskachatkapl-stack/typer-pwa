// Typer PWA Service Worker (BUILD 3043)
const CACHE_NAME = 'typer-cache-3043';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3043',
  './manifest.json?v=3043',
  './apple-touch-icon.png?v=3043',
  './favicon-32x32.png?v=3043',
  './favicon-16x16.png?v=3043',
  './ui/loader_ball.webp',
