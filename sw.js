// Typer PWA Service Worker (BUILD 3033)
const CACHE_NAME = 'typer-cache-3033';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3033',
  './manifest.json?v=3033',
  './apple-touch-icon.png?v=3033',
  './favicon-32x32.png?v=3033',
  './favicon-16x16.png?v=3033',
  './ui/loader_ball.webp',
