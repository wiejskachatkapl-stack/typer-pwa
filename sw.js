// Typer PWA Service Worker (BUILD 3044)
const CACHE_NAME = 'typer-cache-3044';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3044',
  './manifest.json?v=3044',
  './apple-touch-icon.png?v=3044',
  './favicon-32x32.png?v=3044',
  './favicon-16x16.png?v=3044',
  './ui/loader_ball.webp',
