// Typer PWA Service Worker (BUILD 3046)
const CACHE_NAME = 'typer-cache-3046';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3046',
  './manifest.json?v=3046',
  './apple-touch-icon.png?v=3046',
  './favicon-32x32.png?v=3046',
  './favicon-16x16.png?v=3046',
  './ui/loader_ball.webp',
