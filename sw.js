// Typer PWA Service Worker (BUILD 3032)
const CACHE_NAME = 'typer-cache-3032';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3032',
  './manifest.json?v=3032',
  './apple-touch-icon.png?v=3032',
  './favicon-32x32.png?v=3032',
  './favicon-16x16.png?v=3032',
