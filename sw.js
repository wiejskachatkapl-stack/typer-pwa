// Typer PWA Service Worker (BUILD 3009)
const CACHE_NAME = 'typer-cache-3009';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3009',
  './manifest.json?v=3009',
  './apple-touch-icon.png?v=3009',
  './favicon-32x32.png?v=3009',
  './favicon-16x16.png?v=3009',
