// Typer PWA Service Worker (BUILD 3035)
const CACHE_NAME = 'typer-cache-3035';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3035',
  './manifest.json?v=3035',
  './apple-touch-icon.png?v=3035',
  './favicon-32x32.png?v=3035',
  './favicon-16x16.png?v=3035',
  './ui/loader_ball.webp',
