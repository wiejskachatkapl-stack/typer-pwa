// Typer PWA Service Worker (BUILD 3064)
const CACHE_NAME = 'typer-cache-3064';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3064',
  './manifest.json?v=3064',
  './apple-touch-icon.png?v=3064',
  './favicon-32x32.png?v=3064',
  './favicon-16x16.png?v=3064',
  './ui/loader_ball.webp',
