// Typer PWA Service Worker (BUILD 3030)
const CACHE_NAME = 'typer-cache-3030';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3030',
  './manifest.json?v=3030',
  './apple-touch-icon.png?v=3030',
  './favicon-32x32.png?v=3030',
  './favicon-16x16.png?v=3030',
