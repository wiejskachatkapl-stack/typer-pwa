// Typer PWA Service Worker (BUILD 3076)
const CACHE_NAME = 'typer-cache-3076';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3076',
  './manifest.json?v=3076',
  './apple-touch-icon.png?v=3076',
  './favicon-32x32.png?v=3076',
  './favicon-16x16.png?v=3076',
  './ui/loader_ball.webp',
