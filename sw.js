// Typer PWA Service Worker (BUILD 3057)
const CACHE_NAME = 'typer-cache-3057';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3057',
  './manifest.json?v=3057',
  './apple-touch-icon.png?v=3057',
  './favicon-32x32.png?v=3057',
  './favicon-16x16.png?v=3057',
  './ui/loader_ball.webp',
