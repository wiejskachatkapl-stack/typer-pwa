// Typer PWA Service Worker (BUILD 3019)
const CACHE_NAME = 'typer-cache-3019';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3019',
  './manifest.json?v=3019',
  './apple-touch-icon.png?v=3019',
  './favicon-32x32.png?v=3019',
  './favicon-16x16.png?v=3019',
