// Typer PWA Service Worker (BUILD 3021)
const CACHE_NAME = 'typer-cache-3021';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3021',
  './manifest.json?v=3021',
  './apple-touch-icon.png?v=3021',
  './favicon-32x32.png?v=3021',
  './favicon-16x16.png?v=3021',
