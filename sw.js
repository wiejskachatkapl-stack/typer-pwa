// Typer PWA Service Worker (BUILD 3048)
const CACHE_NAME = 'typer-cache-3048';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3048',
  './manifest.json?v=3048',
  './apple-touch-icon.png?v=3048',
  './favicon-32x32.png?v=3048',
  './favicon-16x16.png?v=3048',
  './ui/loader_ball.webp',
