// Typer PWA Service Worker (BUILD 3067)
const CACHE_NAME = 'typer-cache-3067';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3067',
  './manifest.json?v=3067',
  './apple-touch-icon.png?v=3067',
  './favicon-32x32.png?v=3067',
  './favicon-16x16.png?v=3067',
  './ui/loader_ball.webp',
