// Typer PWA Service Worker (BUILD 3077)
const CACHE_NAME = 'typer-cache-3077';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3077',
  './manifest.json?v=3077',
  './apple-touch-icon.png?v=3077',
  './favicon-32x32.png?v=3077',
  './favicon-16x16.png?v=3077',
  './ui/loader_ball.webp',
