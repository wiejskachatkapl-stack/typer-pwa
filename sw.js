// Typer PWA Service Worker (BUILD 3031)
const CACHE_NAME = 'typer-cache-3031';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3031',
  './manifest.json?v=3031',
  './apple-touch-icon.png?v=3031',
  './favicon-32x32.png?v=3031',
  './favicon-16x16.png?v=3031',
