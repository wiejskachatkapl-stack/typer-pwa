// Typer PWA Service Worker (BUILD 3028)
const CACHE_NAME = 'typer-cache-3028';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3028',
  './manifest.json?v=3028',
  './apple-touch-icon.png?v=3028',
  './favicon-32x32.png?v=3028',
  './favicon-16x16.png?v=3028',
