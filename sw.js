// Typer PWA Service Worker (BUILD 3054)
const CACHE_NAME = 'typer-cache-3054';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3054',
  './manifest.json?v=3054',
  './apple-touch-icon.png?v=3054',
  './favicon-32x32.png?v=3054',
  './favicon-16x16.png?v=3054',
  './ui/loader_ball.webp',
