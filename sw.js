// Typer PWA Service Worker (BUILD 3038)
const CACHE_NAME = 'typer-cache-3038';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3038',
  './manifest.json?v=3038',
  './apple-touch-icon.png?v=3038',
  './favicon-32x32.png?v=3038',
  './favicon-16x16.png?v=3038',
  './ui/loader_ball.webp',
