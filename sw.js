// Typer PWA Service Worker (BUILD 3060)
const CACHE_NAME = 'typer-cache-3060';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3060',
  './manifest.json?v=3060',
  './apple-touch-icon.png?v=3060',
  './favicon-32x32.png?v=3060',
  './favicon-16x16.png?v=3060',
  './ui/loader_ball.webp',
