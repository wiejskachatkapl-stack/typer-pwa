// Typer PWA Service Worker (BUILD 3007)
const CACHE_NAME = 'typer-cache-3007';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3007',
  './manifest.json?v=3007',
  './apple-touch-icon.png?v=3007',
  './favicon-32x32.png?v=3007',
  './favicon-16x16.png?v=3007',
