// Typer PWA Service Worker (BUILD 3047)
const CACHE_NAME = 'typer-cache-3047';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3047',
  './manifest.json?v=3047',
  './apple-touch-icon.png?v=3047',
  './favicon-32x32.png?v=3047',
  './favicon-16x16.png?v=3047',
  './ui/loader_ball.webp',
