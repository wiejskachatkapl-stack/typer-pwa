// Typer PWA Service Worker (BUILD 3075)
const CACHE_NAME = 'typer-cache-3075';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3075',
  './manifest.json?v=3075',
  './apple-touch-icon.png?v=3075',
  './favicon-32x32.png?v=3075',
  './favicon-16x16.png?v=3075',
  './ui/loader_ball.webp',
