// Typer PWA Service Worker (BUILD 3036)
const CACHE_NAME = 'typer-cache-3036';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3036',
  './manifest.json?v=3036',
  './apple-touch-icon.png?v=3036',
  './favicon-32x32.png?v=3036',
  './favicon-16x16.png?v=3036',
  './ui/loader_ball.webp',
