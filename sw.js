// Typer PWA Service Worker (BUILD 3072)
const CACHE_NAME = 'typer-cache-3072';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3072',
  './manifest.json?v=3072',
  './apple-touch-icon.png?v=3072',
  './favicon-32x32.png?v=3072',
  './favicon-16x16.png?v=3072',
  './ui/loader_ball.webp',
