// Typer PWA Service Worker (BUILD 3027)
const CACHE_NAME = 'typer-cache-3027';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3027',
  './manifest.json?v=3027',
  './apple-touch-icon.png?v=3027',
  './favicon-32x32.png?v=3027',
  './favicon-16x16.png?v=3027',
