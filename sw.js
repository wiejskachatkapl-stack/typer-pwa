// Typer PWA Service Worker (BUILD 3079)
const CACHE_NAME = 'typer-cache-3079';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3079',
  './manifest.json?v=3079',
  './apple-touch-icon.png?v=3079',
  './favicon-32x32.png?v=3079',
  './favicon-16x16.png?v=3079',
  './ui/loader_ball.webp',
