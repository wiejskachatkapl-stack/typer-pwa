// Typer PWA Service Worker (BUILD 3037)
const CACHE_NAME = 'typer-cache-3037';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3037',
  './manifest.json?v=3037',
  './apple-touch-icon.png?v=3037',
  './favicon-32x32.png?v=3037',
  './favicon-16x16.png?v=3037',
  './ui/loader_ball.webp',
