// Typer PWA Service Worker (BUILD 3068)
const CACHE_NAME = 'typer-cache-3068';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3068',
  './manifest.json?v=3068',
  './apple-touch-icon.png?v=3068',
  './favicon-32x32.png?v=3068',
  './favicon-16x16.png?v=3068',
  './ui/loader_ball.webp',
