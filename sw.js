// Typer PWA Service Worker (BUILD 3011)
const CACHE_NAME = 'typer-cache-3011';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3011',
  './manifest.json?v=3011',
  './apple-touch-icon.png?v=3011',
  './favicon-32x32.png?v=3011',
  './favicon-16x16.png?v=3011',
