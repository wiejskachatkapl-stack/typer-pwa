// Typer PWA Service Worker (BUILD 3017)
const CACHE_NAME = 'typer-cache-3017';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3017',
  './manifest.json?v=3017',
  './apple-touch-icon.png?v=3017',
  './favicon-32x32.png?v=3017',
  './favicon-16x16.png?v=3017',
