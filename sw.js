// Typer PWA Service Worker (BUILD 3053)
const CACHE_NAME = 'typer-cache-3053';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3053',
  './manifest.json?v=3053',
  './apple-touch-icon.png?v=3053',
  './favicon-32x32.png?v=3053',
  './favicon-16x16.png?v=3053',
  './ui/loader_ball.webp',
