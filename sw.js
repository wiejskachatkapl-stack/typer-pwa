// Typer PWA Service Worker (BUILD 3071)
const CACHE_NAME = 'typer-cache-3071';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3071',
  './manifest.json?v=3071',
  './apple-touch-icon.png?v=3071',
  './favicon-32x32.png?v=3071',
  './favicon-16x16.png?v=3071',
  './ui/loader_ball.webp',
