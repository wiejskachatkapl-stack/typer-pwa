// Typer PWA Service Worker (BUILD 3039)
const CACHE_NAME = 'typer-cache-3039';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3039',
  './manifest.json?v=3039',
  './apple-touch-icon.png?v=3039',
  './favicon-32x32.png?v=3039',
  './favicon-16x16.png?v=3039',
  './ui/loader_ball.webp',
