// Typer PWA Service Worker (BUILD 3025)
const CACHE_NAME = 'typer-cache-3025';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3025',
  './manifest.json?v=3025',
  './apple-touch-icon.png?v=3025',
  './favicon-32x32.png?v=3025',
  './favicon-16x16.png?v=3025',
