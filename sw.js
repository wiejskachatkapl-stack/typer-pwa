// Typer PWA Service Worker (BUILD 3018)
const CACHE_NAME = 'typer-cache-3018';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3018',
  './manifest.json?v=3018',
  './apple-touch-icon.png?v=3018',
  './favicon-32x32.png?v=3018',
  './favicon-16x16.png?v=3018',
