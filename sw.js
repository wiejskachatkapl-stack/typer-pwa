// Typer PWA Service Worker (BUILD 3045)
const CACHE_NAME = 'typer-cache-3045';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3045',
  './manifest.json?v=3045',
  './apple-touch-icon.png?v=3045',
  './favicon-32x32.png?v=3045',
  './favicon-16x16.png?v=3045',
  './ui/loader_ball.webp',
