// Typer PWA Service Worker (BUILD 3074)
const CACHE_NAME = 'typer-cache-3074';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3074',
  './manifest.json?v=3074',
  './apple-touch-icon.png?v=3074',
  './favicon-32x32.png?v=3074',
  './favicon-16x16.png?v=3074',
  './ui/loader_ball.webp',
