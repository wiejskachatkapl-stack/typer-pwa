// Typer PWA Service Worker (BUILD 3013)
const CACHE_NAME = 'typer-cache-3013';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3013',
  './manifest.json?v=3013',
  './apple-touch-icon.png?v=3013',
  './favicon-32x32.png?v=3013',
  './favicon-16x16.png?v=3013',
