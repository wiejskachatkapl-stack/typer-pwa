// Typer PWA Service Worker (BUILD 3014)
const CACHE_NAME = 'typer-cache-3014';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3014',
  './manifest.json?v=3014',
  './apple-touch-icon.png?v=3014',
  './favicon-32x32.png?v=3014',
  './favicon-16x16.png?v=3014',
