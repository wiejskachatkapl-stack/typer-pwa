// Typer PWA Service Worker (BUILD 3026)
const CACHE_NAME = 'typer-cache-3026';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3026',
  './manifest.json?v=3026',
  './apple-touch-icon.png?v=3026',
  './favicon-32x32.png?v=3026',
  './favicon-16x16.png?v=3026',
