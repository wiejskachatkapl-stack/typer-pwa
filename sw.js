// Typer PWA Service Worker (BUILD 3010)
const CACHE_NAME = 'typer-cache-3010';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3010',
  './manifest.json?v=3010',
  './apple-touch-icon.png?v=3010',
  './favicon-32x32.png?v=3010',
  './favicon-16x16.png?v=3010',
