// Typer PWA Service Worker (BUILD 3069)
const CACHE_NAME = 'typer-cache-3069';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3069',
  './manifest.json?v=3069',
  './apple-touch-icon.png?v=3069',
  './favicon-32x32.png?v=3069',
  './favicon-16x16.png?v=3069',
  './ui/loader_ball.webp',
