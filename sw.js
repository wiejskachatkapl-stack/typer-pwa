// Typer PWA Service Worker (BUILD 3040)
const CACHE_NAME = 'typer-cache-3040';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3040',
  './manifest.json?v=3040',
  './apple-touch-icon.png?v=3040',
  './favicon-32x32.png?v=3040',
  './favicon-16x16.png?v=3040',
  './ui/loader_ball.webp',
