// Typer PWA Service Worker (BUILD 3080)
const CACHE_NAME = 'typer-cache-3080';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3080',
  './manifest.json?v=3080',
  './apple-touch-icon.png?v=3080',
  './favicon-32x32.png?v=3080',
  './favicon-16x16.png?v=3080',
  './ui/loader_ball.webp',
