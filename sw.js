// Typer PWA Service Worker (BUILD 3005)
const CACHE_NAME = 'typer-cache-3005';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3005',
  './manifest.json?v=3005',
  './apple-touch-icon.png?v=3005',
  './favicon-32x32.png?v=3005',
  './favicon-16x16.png?v=3005',
