// Typer PWA Service Worker (BUILD 3066)
const CACHE_NAME = 'typer-cache-3066';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3066',
  './manifest.json?v=3066',
  './apple-touch-icon.png?v=3066',
  './favicon-32x32.png?v=3066',
  './favicon-16x16.png?v=3066',
  './ui/loader_ball.webp',
