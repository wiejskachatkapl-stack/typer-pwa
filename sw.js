// Typer PWA Service Worker (BUILD 3051)
const CACHE_NAME = 'typer-cache-3051';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3051',
  './manifest.json?v=3051',
  './apple-touch-icon.png?v=3051',
  './favicon-32x32.png?v=3051',
  './favicon-16x16.png?v=3051',
  './ui/loader_ball.webp',
