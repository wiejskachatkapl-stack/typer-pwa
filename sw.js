// Typer PWA Service Worker (BUILD 3073)
const CACHE_NAME = 'typer-cache-3073';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3073',
  './manifest.json?v=3073',
  './apple-touch-icon.png?v=3073',
  './favicon-32x32.png?v=3073',
  './favicon-16x16.png?v=3073',
  './ui/loader_ball.webp',
