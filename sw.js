// Typer PWA Service Worker (BUILD 3063)
const CACHE_NAME = 'typer-cache-3063';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3063',
  './manifest.json?v=3063',
  './apple-touch-icon.png?v=3063',
  './favicon-32x32.png?v=3063',
  './favicon-16x16.png?v=3063',
  './ui/loader_ball.webp',
