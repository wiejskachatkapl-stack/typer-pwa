// Typer PWA Service Worker (BUILD 3070)
const CACHE_NAME = 'typer-cache-3070';
...
const CORE = [
  ...
  './index.html',
  './app.js?v=3070',
  './manifest.json?v=3070',
  './apple-touch-icon.png?v=3070',
  './favicon-32x32.png?v=3070',
  './favicon-16x16.png?v=3070',
  './ui/loader_ball.webp',
